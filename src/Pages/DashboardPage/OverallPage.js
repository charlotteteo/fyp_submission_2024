...
const OverallPage = ({tickers,weights,start_date,end_date,initial_investment}) => {
  ...
  const asyncFetch = () => {
    ...
    fetch(`http://localhost:8082/portfolio/type_pie/${tickers_str}/${weights_str}/${start_date}/${end_date}/${initial_investment}`)
      .then((response) => response.json())
    ...
    fetch(`http://localhost:8082/portfolio/sectoral_pie/${tickers_str}/${weights_str}/${start_date}/${end_date}/${initial_investment}`)
      .then((response) => response.json())
      ...
      fetch(`http://localhost:8082/portfolio/constituent_pie/${tickers_str}/${weights_str}/${start_date}/${end_date}/${initial_investment}`)
      .then((response) => response.json())
